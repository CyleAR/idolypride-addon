...
import io.github.cylear.hoshimi.localify.HoshimiHookMain
...
object FileHotUpdater {
    ...
    fun updateFilesFromZip(activity: Activity, zipFileUri: Uri, filesDir: File, deleteAfterUpdate: Boolean) {
        try {
            HoshimiHookMain.showToast("Updating files from zip...")
            ...
            HoshimiHookMain.showToast("Update file not found.")
        }
        catch (e: Exception) {
            Log.e(TAG, "updateFilesFromZip failed: $e")
            HoshimiHookMain.showToast("Updating files failed: $e")
        }
    }
