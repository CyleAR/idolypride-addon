    ...
    Box(
        ...
        Column(
            ...
            Column(modifier = modifier.fillMaxWidth()
                .padding(10.dp, 10.dp, 10.dp, 0.dp)) {
                Text(text = "Hoshimi Localify Patcher", fontSize = 18.sp)
            ...
            IPGroupBox(modifier = modifier, "Shizuku", contentPadding = 0.dp) {
                ElevatedCard(
            ...
            Box(modifier = Modifier.weight(1f)) {
                IPGroupBox(modifier = modifier, stringResource(R.string.game_patch)) {
                    ...
                    Column(modifier = Modifier,
                        ...
                        IPSwitch(modifier, stringResource(R.string.patch_debuggable), checked = isPatchDebuggable) {
                            isPatchDebuggable = !isPatchDebuggable
                        }

                        IPSwitch(modifier, stringResource(R.string.reserve_patched), checked = reservePatchFiles) {
        ...
        FloatingActionButton(
            onClick = { if (!isPatching) {
                if (ShizukuApi.isPermissionGranted &&
                    ShizukuApi.isPackageInstalledWithoutPatch("game.qualiarts.idolypride")) {
