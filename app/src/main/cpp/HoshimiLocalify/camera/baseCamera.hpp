...
namespace BaseCamera {
	...
	extern float look_radius;  // Rotation radius
	extern float moveAngel;  // Rotation angle
	...
	public:
		...
		float horizontalAngle = 0;  // Horizontal angle
		float verticalAngle = 0;  // Vertical angle
